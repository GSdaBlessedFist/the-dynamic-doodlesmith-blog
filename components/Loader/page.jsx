              ...
              <g id="dynamic-doodlesmith-logo" transform="translate(-51.42 -84.49)" >
                ...
                <g id="words-group">
                  ...
                  <g id="group-oodlesmith">
                    ...
                    <path id="doodlesmith-l" className={styles.doodlesmithLetter} d="M141.5 142.1v-22.8h4.7v22.8z" />
                    ...
                    <path id="doodlesmith-i" className={styles.doodlesmithLetter} d="M193.8 121.4v-3.8h4.6v3.8zm0 20.7v-19.5h4.6v19.5z" />
                    <path id="doodlesmith-t" className={styles.doodlesmithLetter} d="M204.3 142.3c-1.3 0-2.1-.3-2.6-.8-.4-.5-.6-1.3-.6-2.4v-12.2h-1.3v-3.5h1.3v-4.1h4.5v4.1h1.3v3.5h-1.3V138c0 .3.1.5.2.6.1.1.3.2.6.2h.5v3.2c-.1 0-.4.1-1 .2-.5.1-1.1.1-1.6.1z" />
                    <path id="doodlesmith-h" className={styles.doodlesmithLetter} d="M208.4 142.1v-22.8h4.8v5.3c.2-.7.6-1.3 1.1-1.6.5-.4 1.1-.6 1.8-.6 1.4 0 2.4.4 3 1.3.6.9.9 2 .9 3.4v15h-4.7v-14.7c0-.4-.1-.7-.3-1-.1-.3-.4-.4-.8-.4-.3 0-.6.1-.8.4-.1.3-.2.6-.2 1v14.7z" />
                  </g>
                </g>
